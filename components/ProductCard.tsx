...
function ProductCard(props: ProductCardProps) {
    return (
        <div className="shadow-md w-[350px] inline rounded-md">
            <Image className="w-[350px] h-[200px] object-cover relative" src={props.image} alt={props.name} width={200} height={200} />
            <div className="relative bottom-0 p-2 bg-background">
                <div className="text-xl font-bold text-foreground">{props.name}</div>
